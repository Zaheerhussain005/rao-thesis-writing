...
\usepackage{fontspec}
% Times-style main font. TeX Gyre Termes ships with full TeX Live (Overleaf)
% and with MiKTeX once the "tex-gyre" package is installed. If a build ever
% fails with "font cannot be found", comment this line out to fall back to
% the always-available Latin Modern default.
